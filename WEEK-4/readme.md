...
On `resource-group-celebal`, the following roles were assigned to **Shrim Sethi**:
...
**Screenshot reference:** `resource-group-celebal | Access control (IAM)` page showing 4 role assignments — Owner (x2), Reader, and Role Based Access Control Administrator all assigned to Shrim Sethi.
<img width="1632" height="927" alt="Screenshot 2026-06-21 003451" src="https://github.com/user-attachments/assets/f86028ba-77ba-41d6-ba14-afe1c2de4add" />
